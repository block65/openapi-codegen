...
export const imageCreate = [
	validator("query", (value) =>
		standardParse(
			imageCreateCommandQuerySchema,
			parseQuery(value, imageCreateQueryParams),
		),
	),
] as const;
...
const systemDataUsageQueryParams = [
...
export const systemDataUsage = [
	validator("query", (value) =>
		standardParse(
			systemDataUsageCommandQuerySchema,
			parseQuery(value, systemDataUsageQueryParams),
		),
	),
] as const;
...
export const imageGetAll = [
	validator("query", (value) =>
		standardParse(
			imageGetAllCommandQuerySchema,
			parseQuery(value, imageGetAllQueryParams),
		),
	),
] as const;
