...
type PluginPullCommandBodyWrapper = {
	body: PluginPullJsonBody;
};
export type PluginPullCommandInput = PluginPullCommandBodyWrapper &
...
type PluginUpgradeCommandBodyWrapper = {
	body: PluginUpgradeJsonBody;
};
export type PluginUpgradeCommandInput = PluginUpgradeCommandBodyWrapper &
...
type PluginSetCommandBodyWrapper = {
	body: PluginSetJsonBody;
};
export type PluginSetCommandInput = PluginSetCommandBodyWrapper &
	PluginSetCommandParams;
