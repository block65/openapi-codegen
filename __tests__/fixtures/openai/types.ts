...
export type CreateImageRequest = {
	 ...
	 * @example dall-e-3
	 */
	model?: LiteralUnion<"dall-e-2" | "dall-e-3", string> | null;
	/**
...
export type CreateImageEditRequest = {
	 ...
	 * @example dall-e-2
	 */
	model?: LiteralUnion<"dall-e-2", string> | null;
	/**
...
export type CreateSpeechRequest = {
	model: LiteralUnion<"tts-1" | "tts-1-hd", string>;
	input: string;
	/**
...
export type CreateTranslationRequest = {
	 ...
	 * @example whisper-1
	 */
	model: LiteralUnion<"whisper-1", string>;
	prompt?: string;
	/**
	 * The format of the output, in one of these options: `json`, `text`, `srt`,
	 * `verbose_json`, or `vtt`.
