...
import type {
  ...
  FindPetsCommandInputRest,
  Pet,
  NewPet,
  AddPetCommandInput,
  AddPetCommandInputRest,
  FindPetByIdCommandInput,
  FindPetByIdCommandInputRest,
  DeletePetCommandInput,
  DeletePetCommandInputRest,
} from './models.js';
 ...
 *
 */
export class FindPetsCommand extends Command<FindPetsCommandInput, Pet[]> {
